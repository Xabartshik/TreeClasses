...
int main() {
	...
	LegacyString str1("abc");
	LegacyString str2("zxc");
	LegacyString str3("qwerty");
	LegacyString str4("");
	BinarySearchTree<LegacyString> bst_str;

	bst_str.insert(str1);
	bst_str.insert(str2);
	bst_str.insert(str3);

	bst_str.printPreOrder();
	cout << bst_str.search(str1);
